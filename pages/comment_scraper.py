...
def list_of_comments(youtube_id,limit):
    try:
        # youtube_id = "IwozwmBZNSc"
        # output = "Outout.txt"
        # limit = 200
        ...
        print('Adding Youtube comments for video:', youtube_id)
        count = 0
        json_list = []
        ...
        for comment in download_comments(youtube_id):
            ...
            # print(comment)
            json_list.append(comment.copy())
            if limit and count >= limit:
                    break
                    
        comment_list = []
        for com in json_list:
